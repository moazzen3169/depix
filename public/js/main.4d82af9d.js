...
const blogPosts = [
  {
    id: 8,
    slug: "چرا-بعضی-پروژه-های-برنامه-نویسی-ارزان-تر-هستند-تفاوت-قیمت-از-کجاست",
    title: "چرا بعضی پروژه‌های برنامه‌نویسی ارزان‌تر هستند؟ تفاوت قیمت از کجاست؟",
    category: "تعرفه‌ها و هزینه‌ها",
    date: "۱۴۰۵/۰۶/۰۵",
    readTime: "۷ دقیقه",
    image: "./assets/blog/blog8.webp",
    excerpt: "اگر برای طراحی سایت یا توسعه نرم‌افزار قیمت گرفته‌اید و با تفاوت قیمت شدید مواجه شده‌اید، این مقاله دلیل اختلاف قیمت پروژه‌ها و نحوه مقایسه درست پیشنهادات را توضیح می‌دهد.",
    author: {
      name: "هادی موذن",
    ...
    content: {
      intro: "اگر برای طراحی سایت یا توسعه یک نرم‌افزار از چند شرکت و تیم برنامه‌نویسی قیمت بگیرید، احتمالاً با اختلاف قیمت قابل‌توجهی مواجه می‌شوید.\n\nممکن است یک تیم برای یک پروژه مبلغ مشخصی اعلام کند و تیم دیگری برای همان پروژه، چند برابر آن قیمت بدهد. در این شرایط یک سؤال کاملاً طبیعی شکل می‌گیرد:\n\n> **چرا قیمت پروژه‌های برنامه‌نویسی این‌قدر متفاوت است؟**\n\nآیا قیمت بالاتر یعنی کیفیت بهتر؟\nآیا قیمت پایین‌تر یعنی پروژه ضعیف‌تر؟\nیا اینکه بعضی تیم‌ها صرفاً گران‌تر قیمت می‌دهند؟\n\nواقعیت این است که هیچ‌کدام را نمی‌توان به‌صورت مطلق درست دانست.\n\nقیمت یک پروژه نرم‌افزاری به عوامل مختلفی بستگی دارد و برای مقایسه درست، باید ببینیم هر پیشنهاد دقیقاً چه چیزی را شامل می‌شود.",
      sections: [
        {
          title: "۱. همه پروژه‌ها واقعاً یکسان نیستند",
          text: "یکی از رایج‌ترین دلایل اختلاف قیمت این است که مشتری تصور می‌کند دو تیم برای یک پروژه قیمت داده‌اند، در حالی که تعریف پروژه در دو پیشنهاد متفاوت است.\n\nبرای مثال، فرض کنید قصد طراحی یک فروشگاه اینترنتی را دارید.\n\nیک تیم ممکن است یک فروشگاه با امکانات پایه پیشنهاد دهد:",
          list: [
            "نمایش محصولات",
            "سبد خرید",
            "پرداخت آنلاین",
        ...
        {
          text: "اما تیم دیگری علاوه بر این موارد، امکاناتی مثل موارد زیر را در نظر بگیرد:",
          list: [
            ...
            "پنل اختصاصی مشتریان",
            "گزارش‌های فروش",
            "سیستم مدیریت سفارش پیشرفته"
          ]
        },
        {
          text: "طبیعی است که هزینه توسعه این دو پروژه یکسان نباشد.\n\nبنابراین اولین سؤال هنگام مقایسه قیمت این نیست که **«کدام شرکت ارزان‌تر است؟»**، بلکه باید بپرسید: **«هر شرکت دقیقاً چه چیزی را با این قیمت تحویل می‌دهد؟»**"
        },
        {
          title: "۲. استفاده از امکانات آماده می‌تواند هزینه را کاهش دهد",
          text: "همه بخش‌های یک پروژه الزاماً از صفر توسعه داده نمی‌شوند.\n\nگاهی می‌توان از قالب‌ها، افزونه‌ها، کتابخانه‌ها، سرویس‌ها یا سیستم‌های آماده استفاده کرد. این موضوع لزوماً چیز بدی نیست.\n\nاتفاقاً اگر نیازهای یک کسب‌وکار با راهکار آماده به‌خوبی برطرف شود، استفاده از آن می‌تواند باعث شود پروژه با هزینه و زمان کمتر اجرا شود.\n\nاما مشکل زمانی ایجاد می‌شود که یک راهکار آماده برای نیاز خاص یک کسب‌وکار مناسب نباشد و صرفاً برای پایین آوردن قیمت پروژه از آن استفاده شود.\n\nدر این حالت ممکن است در آینده با مشکلاتی مثل محدودیت در توسعه، وابستگی به افزونه‌ها یا هزینه‌های اضافی مواجه شوید.\n\nپس سؤال درست این است:",
          quote: "برای پروژه من چه بخش‌هایی آماده هستند و چه بخش‌هایی اختصاصی توسعه داده می‌شوند؟"
        },
        {
          title: "۳. طراحی اختصاصی، زمان و نیروی بیشتری می‌خواهد",
          text: "در یک پروژه اختصاصی، معمولاً بخش بیشتری از فرآیند باید متناسب با نیاز کسب‌وکار شما طراحی و توسعه داده شود.\n\nاز تحلیل نیازها و طراحی تجربه کاربری گرفته تا طراحی رابط کاربری، توسعه Backend و Frontend، تست و پیاده‌سازی.\n\nهرچه نیازهای پروژه اختصاصی‌تر و پیچیده‌تر باشند، طبیعتاً زمان و نیروی متخصص بیشتری نیاز خواهد بود.\n\nبه همین دلیل، نمی‌توان انتظار داشت یک نرم‌افزار کاملاً اختصاصی با یک سایت ساده و آماده، قیمت مشابهی داشته باشد."
        },
        {
          title: "۴. تجربه تیم هم روی قیمت تأثیر دارد",
          text: "بخشی از هزینه‌ای که برای یک تیم حرفه‌ای پرداخت می‌کنید، بابت تجربه و دانش فنی آن تیم است.\n\nیک تیم باتجربه معمولاً فقط کد نمی‌زند؛ قبل از شروع توسعه، درباره ساختار پروژه، امنیت، مقیاس‌پذیری، تجربه کاربر و مشکلات احتمالی آینده فکر می‌کند.\n\nمثلاً ممکن است دو تیم هر دو بتوانند یک فروشگاه اینترنتی را راه‌اندازی کنند، اما یکی از ابتدا معماری پروژه را طوری طراحی کند که افزایش تعداد محصولات و کاربران در آینده مشکل بزرگی ایجاد نکند.\n\nاین تفاوت شاید در روز اول دیده نشود، اما زمانی که کسب‌وکار رشد می‌کند، اهمیت آن مشخص می‌شود."
        },
        {
          title: "۵. پشتیبانی و خدمات بعد از تحویل را فراموش نکنید",
          text: "گاهی دلیل پایین بودن قیمت این است که خدمات بعد از تحویل پروژه در پیشنهاد وجود ندارد یا بسیار محدود است.\n\nدر مقابل، بعضی تیم‌ها خدماتی مانند موارد زیر را هم در قرارداد یا پکیج خدمات خود در نظر می‌گیرند:",
          list: [
            "رفع باگ",
            "پشتیبانی فنی",
            "نگهداری سرور",
        ...
        {
          text: "بنابراین وقتی دو قیمت را مقایسه می‌کنید، حتماً ببینید بعد از تحویل پروژه چه چیزی دریافت می‌کنید؟ چون ممکن است یک پیشنهاد در ابتدا ارزان‌تر باشد، اما هزینه‌های بعدی آن بیشتر شود."
        },
        {
          title: "۶. زمان انجام پروژه هم اهمیت دارد",
          text: "فرض کنید یک تیم پروژه شما را در دو ماه و تیم دیگری در پنج ماه انجام می‌دهد. این اختلاف زمان می‌تواند دلایل مختلفی داشته باشد.\n\nممکن است تیم اول منابع بیشتری برای پروژه اختصاص دهد، یا پروژه را با فرآیند متفاوتی اجرا کند.\n\nاز طرف دیگر، ممکن است تیم دوم بخش‌های بیشتری را تحلیل، طراحی و تست کند.\n\nبنابراین فقط به «مدت زمان تحویل» نگاه نکنید؛ ببینید در این مدت چه کاری قرار است انجام شود."
        },
        {
          title: "۷. قیمت پایین همیشه بد نیست",
          text: "این نکته مهم است: هر پروژه ارزان‌تری الزاماً پروژه بدی نیست.\n\nاگر نیازهای شما ساده باشد و یک راهکار آماده بتواند آن‌ها را به‌خوبی پوشش دهد، دلیلی ندارد صرفاً برای اختصاصی بودن هزینه بیشتری پرداخت کنید.\n\nمثلاً یک کسب‌وکار کوچک ممکن است با یک سیستم آماده و استاندارد کاملاً به هدفش برسد. در چنین شرایطی، توسعه یک سیستم کاملاً اختصاصی شاید فقط هزینه اضافه ایجاد کند.\n\nبنابراین انتخاب درست همیشه گران‌ترین گزینه نیست."
        },
        {
          title: "۸. قیمت بالا هم لزوماً به معنی کیفیت بالا نیست",
          text: "از طرف دیگر، قیمت بالا به‌تنهایی نشانه حرفه‌ای بودن یک تیم نیست. ممکن است دو تیم دقیقاً یک خروجی مشابه ارائه دهند اما قیمت‌های متفاوتی داشته باشند.\n\nبه همین دلیل بهتر است به جای اینکه فقط قیمت را مقایسه کنید، موارد زیر را هم بررسی کنید:",
          list: [
            "محدوده دقیق پروژه",
            "امکانات و قابلیت‌ها",
        ...
        {
          title: "پس چطور قیمت‌های مختلف را مقایسه کنیم؟",
          text: "بهترین روش این است که قبل از مقایسه قیمت، شرح پروژه یکسانی برای تمام تیم‌ها داشته باشید. برای مثال مشخص کنید:",
          list: [
            "چه صفحاتی نیاز دارید؟",
            "چه امکاناتی باید وجود داشته باشد؟",
            "چه سیستم‌هایی باید به سایت متصل شوند؟",
            "چه چیزی در پایان پروژه تحویل داده می‌شود؟",
            "پشتیبانی چطور خواهد بود؟"
          ]
        },
        {
          text: "بعد پیشنهادهای مختلف را بر اساس همین موارد مقایسه کنید.\n\nدر این حالت، به جای اینکه فقط بگویید: **«این تیم ۱۰۰ میلیون گفت و آن یکی ۱۵۰ میلیون»**، می‌توانید ببینید که چرا یکی ۱۰۰ میلیون و دیگری ۱۵۰ میلیون قیمت داده است."
        },
        {
          title: "در نهایت، پروژه ارزان‌تر بهتر است یا گران‌تر؟",
          text: "هیچ جواب یکسانی برای همه پروژه‌ها وجود ندارد.\n\nگاهی یک راهکار ساده و کم‌هزینه کاملاً نیاز کسب‌وکار را برطرف می‌کند و پرداخت هزینه بیشتر منطقی نیست. گاهی هم پروژه به یک راهکار اختصاصی، معماری قابل توسعه و پشتیبانی حرفه‌ای نیاز دارد و پایین آوردن هزینه در مرحله توسعه، می‌تواند در آینده هزینه بسیار بیشتری ایجاد کند.\n\n**هدف نباید پیدا کردن ارزان‌ترین تیم باشد؛ هدف باید پیدا کردن مناسب‌ترین راهکار برای نیاز واقعی کسب‌وکار باشد.**\n\nقبل از تصمیم‌گیری، به جای پرسیدن فقط «قیمت چقدره؟» بپرسید: **«با این قیمت، دقیقاً چه چیزی قرار است تحویل بگیرم؟»**\n\nهمین یک سؤال می‌تواند تفاوت بین چند پیشنهاد ظاهراً مشابه را کاملاً مشخص کند."
        }
      ]
    }
  },
  ...
  {
    id: 7,
    slug: "طراحی-و-برنامه-نویسی-سایت-اختصاصی",
    title: "طراحی و برنامه‌نویسی سایت اختصاصی",
    ...
    content: {
      intro: "اگر کسب‌وکار شما به سایتی فراتر از قالب‌های آماده و امکانات محدود نیاز دارد، طراحی و توسعه یک سایت اختصاصی می‌تواند راهکار مناسب‌تری باشد.\n\nما پروژه‌های طراحی و برنامه‌نویسی سایت را متناسب با نیاز، اهداف و فرآیندهای هر کسب‌وکار اجرا می‌کنیم؛ از تحلیل نیازمندی‌ها و طراحی رابط کاربری تا برنامه‌نویسی، تست و آماده‌سازی برای انتشار.",
      sections: [
        {
          title: "فرآیند اجرای پروژه",
          text: "فرآیند توسعه سایت با شناخت دقیق نیازهای پروژه شروع می‌شود. ابتدا امکانات، کاربران هدف و اهداف کسب‌وکار بررسی می‌شوند و ساختار فنی و مسیر اجرای پروژه مشخص می‌شود.\n\nپس از آن، طراحی UI/UX انجام شده و تیم برنامه‌نویسی توسعه بخش‌های مختلف سایت را آغاز می‌کند. در طول توسعه، عملکرد و کیفیت بخش‌های مختلف بررسی و تست می‌شود تا سایت آماده استفاده و توسعه‌های آینده باشد."
        },
        {
          title: "زمان و کیفیت؛ دو بخش مهم اجرای پروژه",
          text: "زمان اجرای یک سایت اختصاصی به عواملی مانند امکانات موردنیاز، پیچیدگی پروژه، طراحی رابط کاربری، سیستم‌های موردنیاز و اتصال به سرویس‌های دیگر بستگی دارد.\n\nما پیش از شروع توسعه تلاش می‌کنیم محدوده پروژه و زمان‌بندی اجرای آن را شفاف کنیم تا مسیر کار برای شما مشخص باشد.\n\nدر کنار سرعت اجرای پروژه، **کیفیت کدنویسی، ساختار مناسب فنی، عملکرد، امنیت و قابلیت توسعه سایت** نیز برای ما اهمیت دارد. هدف این است که سایت فقط برای امروز ساخته نشود و در آینده نیز امکان توسعه و اضافه کردن قابلیت‌های جدید را داشته باشد."
        },
        {
          title: "پروژه سایت شما را با ما شروع کنید",
          text: "اگر برای کسب‌وکارتان به یک سایت اختصاصی نیاز دارید یا ایده‌ای دارید که نمی‌دانید چگونه باید به یک محصول تحت وب تبدیل شود، اطلاعات اولیه پروژه را برای ما ارسال کنید.\n\n**فرم درخواست پروژه را تکمیل کنید تا تیم ما اطلاعات شما را بررسی کند و برای گفتگو درباره نیازمندی‌ها، زمان‌بندی و مسیر اجرای پروژه با شما تماس بگیرد.**\n\nدر فرم، هر اطلاعاتی که درباره ایده، امکانات موردنیاز، نمونه‌های موردنظر و زمان‌بندی پروژه دارید وارد کنید. پس از بررسی اولیه، تیم ما برای ادامه گفتگو با شما تماس خواهد گرفت.",
          quote: "آماده شروع هستید؟ از طریق بخش درخواست مشاوره یا فرم انتهای صفحه، اطلاعات پروژه خود را ارسال کنید تا مسیر توسعه اختصاصی سایت شما را شفاف کنیم."
        }
      ]
    }
  },
...
function initAllProjectsPage() {
  ...
  const filterBadgeCount = document.getElementById('projects-filter-badge-count');
  const activeFiltersBar = document.getElementById('projects-active-filters-bar');
  const activeChipsContainer = document.getElementById('projects-active-chips-container');

  // Filter Modal Elements
  const filterModal = document.getElementById('projects-filter-modal');
  const modalCloseBtn = document.getElementById('projects-filter-modal-close');
  const modalResetBtn = document.getElementById('projects-modal-reset-btn');
  const modalApplyBtn = document.getElementById('projects-modal-apply-btn');
  const modalMatchCount = document.getElementById('projects-modal-match-count');
  ...
  const categoryLabels = {
    ...
    saas: 'سامانه و نرم‌افزار',
    dashboard: 'داشبورد و پنل'
  };
  ...
  // Compute matching projects based on given parameters
  const computeFilteredProjects = (cat, type, ind, tech, query, sort) => {
    let result = projects.filter(p => cat === 'all' || p.category === cat);

    if (type !== 'all') {
      result = result.filter(p => p.type === type || (p.specs && p.specs.type && p.specs.type.includes(type)));
    }
    ...
    if (ind !== 'all') {
      result = result.filter(p => {
        ...
        return catLabel.includes(ind) || desc.includes(ind) || specType.includes(ind);
      });
    }
    ...
    if (tech !== 'all') {
      result = result.filter(p => {
        ...
        return p.specs.techs.some(t => t.includes(tech));
      });
    }
  ...
  const updateChipStylesInModal = () => {
    filterChipBtns.forEach(btn => {
      const filterType = btn.getAttribute('data-type');
      const val = btn.getAttribute('data-value');

      let isActive = false;
      if (filterType === 'category' && activeCategory === val) isActive = true;
      if (filterType === 'projectType' && activeProjectType === val) isActive = true;
      if (filterType === 'industry' && activeIndustry === val) isActive = true;
      if (filterType === 'tech' && activeTech === val) isActive = true;

      if (isActive) {
        btn.className = 'filter-chip-btn px-4 py-2 rounded-xl text-xs font-bold border transition-all cursor-pointer bg-primary-accent text-white border-primary-accent shadow-sm';
      } else {
        btn.className = 'filter-chip-btn px-4 py-2 rounded-xl text-xs font-bold border transition-all cursor-pointer bg-card-bg text-muted-fg border-border-subtle hover:border-primary-accent/40';
      }
    });

    // Update modal live matching count
    const matches = computeFilteredProjects(activeCategory, activeProjectType, activeIndustry, activeTech, searchQuery, activeSort);
    if (modalMatchCount) {
      modalMatchCount.textContent = toPersianDigits(matches.length);
    }
  };

  const updateActiveChipsBar = () => {
    const activeFilters = [];
    if (activeCategory !== 'all') {
      activeFilters.push({ type: 'category', label: categoryLabels[activeCategory] || activeCategory });
    }
    if (activeProjectType !== 'all') {
      activeFilters.push({ type: 'projectType', label: projectTypeLabels[activeProjectType] || activeProjectType });
    }
    if (activeIndustry !== 'all') {
      activeFilters.push({ type: 'industry', label: `صنعت: ${activeIndustry}` });
    }
    if (activeTech !== 'all') {
      activeFilters.push({ type: 'tech', label: `تکنولوژی: ${activeTech}` });
    }

    // Update filter badge button count
    if (filterBadgeCount) {
      if (activeFilters.length > 0) {
        filterBadgeCount.textContent = toPersianDigits(activeFilters.length);
        filterBadgeCount.classList.remove('hidden');
      } else {
        filterBadgeCount.classList.add('hidden');
      }
    }

    // Render chips in top container bar
    if (activeFiltersBar && activeChipsContainer) {
      if (activeFilters.length > 0) {
        activeChipsContainer.innerHTML = '';
        activeFilters.forEach(f => {
          const chip = document.createElement('span');
          chip.className = 'inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white/20 text-white font-bold text-[11px] border border-white/30';
          chip.innerHTML = `
            <span>${f.label}</span>
            <button type="button" class="remove-chip-btn hover:text-red-200 cursor-pointer p-0.5" aria-label="حذف فیلتر">
          ...
          chip.querySelector('.remove-chip-btn').addEventListener('click', () => {
            if (f.type === 'category') activeCategory = 'all';
            else if (f.type === 'projectType') activeProjectType = 'all';
            else if (f.type === 'industry') activeIndustry = 'all';
            else if (f.type === 'tech') activeTech = 'all';

            updateChipStylesInModal();
            updateProjects();
          });
  ...
  const updateProjects = () => {
    const result = computeFilteredProjects(activeCategory, activeProjectType, activeIndustry, activeTech, searchQuery, activeSort);
    ...
    // 2. Update Badge Counter inside Search Container
    if (countBadge) {
      countBadge.textContent = `${toPersianDigits(result.length)} پروژه`;
    }

    // 3. Update Active Chips Bar & Filter Button Counter
  ...
  const openFilterModal = () => {
    ...
    updateChipStylesInModal();
    filterModal.classList.remove('pointer-events-none');
    document.body.style.overflow = 'hidden';
    setTimeout(() => {
      filterModal.classList.remove('opacity-0');
      const card = filterModal.querySelector('.modal-card');
  ...
  const closeFilterModal = () => {
    ...
    setTimeout(() => {
      filterModal.classList.add('pointer-events-none');
  ...
  if (filterModal) {
    ...
    document.addEventListener('keydown', (e) => {
      if (e.key === 'Escape' && !filterModal.classList.contains('pointer-events-none')) {
        closeFilterModal();
      }
    });
  }
